...
public class FrmRegistroClientes extends JInternalFrame implements ActionListener, KeyListener, MouseListener {
...
//		setIconifiable(true);
	...
	private void mostrarData(int posFila) {
		...
		razSocial = tblClientes.getValueAt(posFila, 1).toString();
		ruc = tblClientes.getValueAt(posFila, 2).toString();
		telf = tblClientes.getValueAt(posFila, 3).toString();
		direc = tblClientes.getValueAt(posFila, 4).toString();
		correo = tblClientes.getValueAt(posFila, 5).toString();
